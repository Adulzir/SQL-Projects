...
tablename1 = 'NashvilleHousing'

# Use Pandas to read csv file(s) into a dataframe
df1 = pd.read_excel('/enter/path/name/to/NashvilleHousingData.xlsx')

# Obtain a SQLAlchemy engine object to connect to the MySQL database server by providing required credentials
engine = create_engine('mysql+pymysql://root:password@localhost/Housing')
